public class Main {
    public static void main(String[] args) {
        ...
        int placeSeatFree = 50;
        int carriageSeat = 102;
        if (placeSeatFree >= 102) {
            System.out.println("В вагоне осталось " + (carriageSeat - placeSeatFree) + " свободных мест(а). " +
                    "Из них: " + (carriageSeat - 60 - placeSeatFree) + " сидячих мест(а) и "+ placeSeatFree + " стоячих мест(а), ");
        } else {
            System.out.println("В вагоне осталось свободных " + (carriageSeat - placeSeatFree) + " мест.");
        }
    }
}
